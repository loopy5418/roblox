--[[
  UI lib used by Minor's ui - modified to work with modern executors
  do not use without the permission of "julianogoisabaddie" on discord
]]
...
local library = {
    version = "2.0.2",
    title = title or "xsx minor modified" .. tostring(math.random(1,366)),
    fps = 0,
    rank = "private"
}
...
function library:Watermark(text)
    ...
    tetx = text or "xsx minor modified"
...
function library:Introduction()
    ...
    xsx.Text = "powered by xsx (minor modified)"
